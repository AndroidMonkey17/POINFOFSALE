...
<head>
    ...
    <link rel="shortcut icon" href="images/ico/SE.ico">
	           ...
	           <form action="Account Form Success.php" method="POST">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="Receipt.php">Receipt</a></li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="Account Form.php"> Account Register</a></li>
        		...
        		<div class="panel-heading">
			    		...
			    		<form role="form">
			    			...
			    			<div class="form-group">
			    				<input type="text" name="accID" id="accID" class="form-control input-sm" placeholder="AccountID"require autofocus>
			    			</div>
							<div class="form-group">
