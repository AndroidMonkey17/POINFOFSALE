...
<head>
    ...
    <title>Delete Employee | Point of Sale</title>
    ...
    <link rel="shortcut icon" href="images/ico/SE.ico">
	           ...
	           <form action="Delete Success.php" method="POST">
                ...
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="active" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="Delete.php"><span class="glyphicon glyphicon-trash"></span> Delete Employee</a></li>
							<li class="divider"></li>
        		...
        		<div class="panel-heading">
			    		...
			    		<form role="form">
			    			...
			    			<div class="form-group">
			    				<input type="text" name="accID" id="accID" class="form-control input-sm" placeholder="AccountID" required autofocus>
			    			</div>
			    			<br>
