...
<head>
  ...
  <form action="Receipt Success.php" method="POST">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="Receipt.php">Receipt</a></li>
							<li class="dropdown">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Type Here! <small>It's free!</small></h3>
			 			</div>
...
<input type="text" name="quant" id="quant" class="form-control input-sm" placeholder="Quantity">
								...
								<div class="col-xs-4 col-sm-4 col-md-4">
			    					<div class="form-group">
			    						<input type="text" name="cash" id="cash" class="form-control input-sm" placeholder="Cash">
			    					</div>
			    				</div>
			    			</div>
...
echo'<table border="1" width="30%"><th>ProductCode</th><th>ProductName</th><th>Price</th><th>Quantity</th>';
