...
<head>
    ...
    <title>Update Account | Point of Sale</title>
...
<body>
	...
	<nav class="navbar navbar-inverse navbg">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="active" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="Update Account.php"><span class="glyphicon glyphicon-save"></span> Update Account</a></li>
		...
		<div class="container">
		<div class="cont">
		<div class="label1">Update Account</div>
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Fill-Up Here! <small>It's free!</small></h3>
			 			</div>
			 			<div class="panel-body">
			    		<form role="form">
			    			
			    			<div class="form-group">
			    				<input type="text" name="accID" id="accID" class="form-control input-sm" placeholder="Account ID">
			    			</div>
